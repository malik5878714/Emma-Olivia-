...
const dataPath = __dirname + "/𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀u/approvedThreads.json";
const dataPending = __dirname + "/𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀u/pendingdThreads.json";
const fs = require("fs");
  ...
  const cre = this.config.credits
   ...
   let admID = "61594011388225";    
    ...
    var firstname = data[obj].name.replace("@", "");  
      ...
      axios.get('https://anime.apiby𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀.repl.co/img/anime').then(res => {
