...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `»Notice from Owner 𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀 «\n\n${c}, You are stupid for cursing bots so bots automatically banned you from the system`
	};
    //Add curse words without capital letters
	["bot mc", "Mc bot", "Chutiya bot", "Bsdk bot", "Bot teri maa ki chut", "Jhatu bot", "Rhaine bobo", "stupid bots", "chicken bot", "Bot lund", "𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀 mc", "Mc 𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀", "Bsdk 𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀", "fuck bots", "𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀 chutiya", "𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀 gandu", "bobo Ginoong choru bot", "𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀 bc", "crazy bots", "bc 𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀", "Nikal bsdk bot", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot cau"].forEach((a => {
