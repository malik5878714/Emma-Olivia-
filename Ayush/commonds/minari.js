...
const chatbot  =  new  Chatbot({name: "Minari", gender: "Najimi"});
 ...
 if(res === "My dear great botmaster, 𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀.") {
    api.sendMessage(`I made by master 𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀, also known as 𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀u`, event.threadID, event.messageID)
    return;
              }   
      if(res === "My birthplace is 𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀's laptop. What is your birthplace?") {
